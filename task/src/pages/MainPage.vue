<template>
  <div class="container" style="">
    <div style="margin: 0 auto; align-items: center; width: 100%;">
      <el-row style="float: left; width: 100%;">
        <el-col :span="6">
          <el-button style="width: 100%;" type="primary" @click="showDialogCreate">Создать пользователя</el-button>
        </el-col>
        <el-col :span="12">
          <el-input placeholder="Поиск по фамилии..." v-model="searchQuery" ></el-input>
        </el-col>
        <el-col :span="6">
